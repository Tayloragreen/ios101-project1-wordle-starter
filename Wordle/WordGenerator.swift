...
class WordGenerator {
  ...
  static let possibleWords = [
    "APPLE", "BRAIN", "CRANE", "DREAM", "ELITE",
    "FRAME", "GRACE", "HOUSE", "INPUT", "JOKER",
    "KNIFE", "LUNCH", "MIGHT", "NORTH", "OCEAN",
    "PLANE", "QUILT", "ROBIN", "SNAKE", "TRUST",
    "UNITY", "VIVID", "WATER", "XENON", "YOUTH", "ZEBRA"
  ]
